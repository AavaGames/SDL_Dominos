...
GameEntity::GameEntity(Vector2 pos) : mPosition(pos.x, pos.y), mRotation(0.0f), mScale(Vec2_One), mActive(true), mParent(nullptr) {}
...
void GameEntity::Scale(float x, float y)
{
	mScale = Vector2(x, y);
}
